 ...
 */
export function buildExtractionPrompt(message, today) {
 ...
 */
export function validateExtractionResult(raw, log) {
    ...
    const people = Array.isArray(activity.people)
        ? activity.people.filter((p) => typeof p === 'string')
        : [];
 ...
 */
export function parseExtractionJson(text, log) {
